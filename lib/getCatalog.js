...
// Função para buscar episódios de Doctor Who
...
async function getCatalog(type, id, language, genre, page) {
  if (id === "tmdb.top" && !genre) {
    return await getTrending(type, id, language, "week", page);
  }

  if (id === "doctorwho.episodes") {
...
module.exports = { getCatalog, getDoctorWhoEpisodes };
